...
export type CloseInput<
  ...
  TAccountCrud extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountCrud>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountCrud> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.crud),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountCrud>;
